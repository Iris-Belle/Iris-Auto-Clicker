...
internal class ClickerConstruct
{
        ...
        bool burstMode)
    {
        ...
        _sendInputAction = ActionBind.IsKey ^ ActionBind.IsMouse
            ...
            : throw new ArgumentException("blah blah blah blah *crashes cutely*"); // sillier crash message for extreme max silliness
    ...
    public void UpdateActivationBind(ClickBind newBind)
    {
        ...
        RecalculateCaches(); //cachae theese nuts hah gottenm
    }
}